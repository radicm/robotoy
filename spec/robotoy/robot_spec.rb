...
describe Robotoy::Robot do
  ...
  describe "place" do
    context "place with invalid coordinate" do
      it "raises runtime error" do
        expect { subject.place(1, -1, direction) }.to raise_error(RuntimeError, "Invalid coordinates!")
      end
    ...
    context "place with invalid direction" do
      it "raises runtime error" do
        expect { subject.place(1, 1, "xyz") }.to raise_error(RuntimeError, "Invalid direction!")
      end
    end
  end
  ...
  describe "rotate" do
    ...
    it "rotates to left" do
      expect { subject.rotate("xyz") }.to raise_error(RuntimeError, "Invalid direction!")
    end
  end
